...
if(isset($_POST['submit'])){
	...
	$nama_photo=$_FILES['photo']['name'];
		...
		if(empty($_FILES['photo']['name'])){
				...
				$type=$_POST['type'];				
				$query=mysql_query("update kegiatan set nama='$nama',kategori='$kategori',fakultas='$fakultas',prodi='$prodi',tempat='$tempat',tanggal='$tanggal',photo='$nama_file_upload',type='$type' where id_user='$id_user'");
			}else{				
